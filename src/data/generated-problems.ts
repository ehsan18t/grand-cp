// Auto-generated from grand-cp-list.md

import type { ProblemData } from "./problems";

const phase2: ProblemData[] = [
  {
    number: 146,
    platform: "leetcode",
    name: "Min Stack",
